...
public interface RegistryService {
     ...
     */
    void subscribe(URL url, ChildListener listener) throws Exception;
     ...
     * @param listener 变更事件监听器，不允许为空
     */
    void unsubscribe(URL url, ChildListener listener) throws Exception;
