...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b>Vdcluster</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active" id="service-tab"><a href="#"><i class="fa fa-link"></i> <span>服务管理</span></a></li>
                <li><a href="#" id="node-tab"><i class="fa fa-link"></i> <span>节点管理</span></a></li>
                <%--<li class="treeview">--%>
...
<script>
    ...
    $(function(){
        ...
        $("#node-tab").click(function(){

            $.get("${ctx}/main/get-node-list",{},function(data){
