 ...
 * @author Joel Meyer
 */
public abstract class AbstractConnectionRequired implements ConnectionStatusListener {
  private static final Logger LOGGER = Logger.getLogger(AbstractConnectionRequired.class);
  protected final ConnectionStatusMonitor connectionMonitor;
  protected final String threadName;
  protected Thread executingThread;
  
  public AbstractConnectionRequired(ConnectionStatusMonitor connectionMonitor, String name) {
